...
export function HowItWorks() {
  ...
  return (
    <section id="comment-ca-marche" className="py-20 px-6 bg-gradient-to-br from-blue-50 via-cyan-50 to-white">
          ...
          {steps.map((step, i) => (
            ...
            >
              <div className="relative mb-6">
                ...
                {i < steps.length - 1 && (
                  <motion.div 
                    className="hidden md:block absolute top-10 left-1/2 w-full h-0.5 bg-gradient-to-r from-blue-300 via-orange-300 to-cyan-300"
                    initial={{ scaleX: 0 }}
                ...
                <motion.div
                  className="absolute -top-2 -right-2 w-8 h-8 bg-white rounded-full flex items-center justify-center text-blue-600 font-bold text-sm shadow-md border-2 border-blue-100"
                  initial={{ scale: 0 }}
                  whileInView={{ scale: 1 }}
                  viewport={{ once: true }}

        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            {['Accueil', 'Services', 'Comment ça marche', 'Professionnels'].map((item, index) => (
              <motion.a
                ...
                className={`font-medium transition-colors relative group ${isScrolled ? 'text-gray-700 hover:text-blue-600' : 'text-white hover:text-white/80'}`}
          ...
          <div className="hidden md:flex items-center space-x-4">
            <motion.button 
              ...
              className={`font-semibold transition-colors px-5 py-2.5 border-2 rounded-full ${isScrolled ? 'text-blue-600 border-blue-600 hover:bg-blue-50' : 'text-white border-white hover:bg-white/10'}`}
